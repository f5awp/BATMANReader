...
enum AppLegend {
    ...
    static let sections: [Section] = [
        ...
        Section(title: "Markers", items: [
            ...
            Item(swatch: .icon("circle", AppColor.heat), name: "High-demand date",
                 meaning: "A disc around the date — an auto-marked hot date (holidays, etc.)"),
            Item(swatch: .icon("circle", AppColor.milestone), name: "Personal milestone",
                 meaning: "A disc around the date — a protected personal date"),
